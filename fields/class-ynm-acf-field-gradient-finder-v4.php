...
if (!class_exists('ynm_acf_field_gradient_finder')) :
	...
	*/
		...
		function __construct($settings)
		{
			...
			$this->label = __('Gradient Finder');
			$this->category = __("Basic", 'acf-gradient-finder'); // Basic, Content, Choice, etc
			$this->defaults = array(
	...
	*/
		...
		*/
		...
		<tr class="field_option field_option_<?php echo $this->name; ?>">
			<td class="label">
				<label><?php _e("Preview Size", 'acf-gradient-finder'); ?></label>
				<p class="description"><?php _e("Thumbnail is advised", 'acf-gradient-finder'); ?></p>
			</td>
			<td>
				<?php
				...
				do_action('acf/create_field', array(
					...
					'layout'	=>	'horizontal',
					'choices'	=>	array(
						'thumbnail' => __('Thumbnail', 'acf-gradient-finder'),
						'something_else' => __('Something Else', 'acf-gradient-finder'),
					)
				));
